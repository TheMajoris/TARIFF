...
test('calculator success ad valorem calculation', async ({ page }) => {
    ...
    await expect(page.getByRole('main')).toContainText('$105.00');
})
...
test('calculator success specific calculation', async ({ page }) => {
    ...
    await expect(page.getByRole('main')).toContainText('$5.0/1kg');
    await expect(page.getByRole('main')).toContainText('+ $1000.00');
    await expect(page.getByRole('main')).toContainText('$1100.00');
})
