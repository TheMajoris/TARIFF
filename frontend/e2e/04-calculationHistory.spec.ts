...
test('check Ad Valorem history', async ({ page }) => {
    ...
    await expect(page.getByRole('main')).toContainText('854231');
    await expect(page.getByRole('main')).toContainText('US → SG');
    ...
    await expect(page.getByRole('main')).toContainText('USD 5.00');
    await expect(page.getByRole('main')).toContainText('USD 105.00');
    await expect(page.getByRole('main')).toContainText('Ad valorem tariff notes');
})


test('check Specific history', async ({ page }) => {
    await expect(page.getByRole('main')).toContainText('USD 700.00');
    ...
    await expect(page.getByRole('main')).toContainText('USD 1000.00');
    await expect(page.getByRole('main')).toContainText('USD 1100.00');
