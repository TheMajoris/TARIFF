...
public class TariffCalculatorService {
    ...
    public TariffCalculatorService(TariffRateRepository tariffRateRepository) {
        ...
        // sets the tariffRate attribute in the TariffCalculator class based origin
        // country, destination country & hscode
    public void setTariffRate(TariffCalculator tariffCalculator, Long importingCountryId, Long exportingCountryId,
            Integer hsCode) {
        // get the tariff rate from the database using the repository, based on the
        // importing country, exporting country, hs code and current date
