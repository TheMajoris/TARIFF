...
public class CountryEntity {
    ...
    public List<SavedCalculationsEntity> getImportingCalculations() {
        return importingCalculations;
    }

    public void setImportingCalculations(List<SavedCalculationsEntity> importingCalculations) {
        this.importingCalculations = importingCalculations;
    }

    public List<SavedCalculationsEntity> getExportingCalculations() {
        return exportingCalculations;
    }

    public void setExportingCalculations(List<SavedCalculationsEntity> exportingCalculations) {
        this.exportingCalculations = exportingCalculations;
    }

    public List<TariffRateEntity> getImportingTariffRates() {
        return importingTariffRates;
    }

    public void setImportingTariffRates(List<TariffRateEntity> importingTariffRates) {
        this.importingTariffRates = importingTariffRates;
    }

    public List<TariffRateEntity> getExportingTariffRates() {
        return exportingTariffRates;
    }

    public void setExportingTariffRates(List<TariffRateEntity> exportingTariffRates) {
        this.exportingTariffRates = exportingTariffRates;
    }
