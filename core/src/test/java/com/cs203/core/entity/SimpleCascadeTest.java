...
class SimpleCascadeTest {
    ...
    void shouldUpdateProductCategoriesEntityWithCascade() {
        ...
        ProductCategoriesEntity productCategory = new ProductCategoriesEntity(850110, "DC Motors", "Electric motors description", true);
        ...
        ProductCategoriesEntity updatedCategory = entityManager.find(ProductCategoriesEntity.class, productCategory.getId());
        SavedCalculationsEntity updatedCalculation = entityManager.find(SavedCalculationsEntity.class, calculation.getId());
        TariffRateEntity updatedTariffRate = entityManager.find(TariffRateEntity.class, tariffRate.getId());
        NationalTariffLinesEntity updatedTariffLine = entityManager.find(NationalTariffLinesEntity.class, tariffLine.getId());
    ...
    void shouldUpdateUserEntityWithCascade() {
        ...
        ProductCategoriesEntity productCategory = new ProductCategoriesEntity(850120, "AC Motors", "AC motors description", true);
