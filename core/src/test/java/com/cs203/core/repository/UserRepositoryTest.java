...
public class UserRepositoryTest {
    ...
    void setUp() {
        // Create test data
        adminUser = new UserEntity("admin123", "admin@company.com", "hashedPassword1");
        adminUser.setIsAdmin(true);
        adminUser.setFirstName("John");
        adminUser.setLastName("Admin");

        regularUser1 = new UserEntity("john_doe", "john.doe@gmail.com", "hashedPassword2");
        regularUser1.setIsAdmin(false);
        regularUser1.setFirstName("John");
        regularUser1.setLastName("Doe");

        regularUser2 = new UserEntity("jane_smith", "jane.smith@company.com", "hashedPassword3");
        regularUser2.setIsAdmin(false);
        regularUser2.setFirstName("Jane");
        regularUser2.setLastName("Smith");

        gmailUser = new UserEntity("test_user", "test@gmail.com", "hashedPassword4");
    ...
    void testSaveAndFindUser() {
        UserEntity newUser = new UserEntity("newuser", "newuser@test.com", "hashedPassword5");
