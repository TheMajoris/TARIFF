...
class ProductCategoriesRepositoryTest {
    ...
    void setUp() {
        // Create test data
        electronics = new ProductCategoriesEntity(850110, "Electronic Equipment", "Consumer electronics and components", 5.5);
    ...
    void shouldReturnEmptyWhenCategoryNameNotFound() {
        Optional<ProductCategoriesEntity> result = productCategoriesRepository.findByCategoryName("Non-existent Category");
    ...
    void shouldSaveAndFindNewCategory() {
        ProductCategoriesEntity newCategory = new ProductCategoriesEntity(123456, "Test Category", "Test description", 7.5);
